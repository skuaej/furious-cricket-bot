...
def main():
    ...
    app.add_handler(CommandHandler("team_score", unified_score))
    app.add_handler(CommandHandler("score_solo", unified_score))
    ...
    app.add_handler(CommandHandler("list_solo", solo_list_cmd))
    app.add_handler(CommandHandler("list_team", team_list_cmd))
